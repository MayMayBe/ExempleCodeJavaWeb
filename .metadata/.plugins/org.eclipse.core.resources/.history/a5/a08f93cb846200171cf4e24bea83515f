            ...
            <div class="container">
                ...
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><spring:message code="newAccount" /> / <spring:message code="signIn" /></li>
                    </ul>
				 ...
				 <div class="col-md-6">
                    <div class="box">
                        ...
                        <hr>
						<c:if test="${not empty loginError.content}">
	                        	<p class="lead"> ${loginError.content}</p>
                        </c:if>
                        <form:form id="login" method="POST" action="/rocknshop/loginRegister/login" modelAttribute="client">
                ...
                <div class="col-md-6">
                    <div class="box">
                        ...
                        <p class="lead"><spring:message code="notCustomer" /></p>
	                        ...
	                        <c:if test="${not empty errorMessage.content}">
	                        	<p class="lead"> ${errorMessage.content}</p>
	                        </c:if>
                        

                        <form:form id="inscription" method="POST" action="/rocknshop/loginRegister/send" modelAttribute="newClient">
