...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link href='http://fonts.googleapis.com/css?family=Roboto:400,500,700,300,100' rel='stylesheet' type='text/css'>
        ...
        <!-- styles -->
    <link href="<spring:url value='/css/font-awesome.css' />"  rel="stylesheet">
    <link href="<spring:url value='/css/bootstrap.min.css' />"  rel="stylesheet">
    <link href="<spring:url value='/css/animate.min.css' />"  rel="stylesheet">
    <link href="<spring:url value='/css/owl.carousel.css' />"  rel="stylesheet">
    <link href="<spring:url value='/css/owl.theme.css' />"  rel="stylesheet">

    <!-- theme stylesheet -->
    <link href="<spring:url value='/css/style.red.css' />" rel="stylesheet" id="theme-stylesheet">
    ...
    <link rel="shortcut icon" href="<spring:url value='/images/favicon.png' />">
        ...
        <div class="container">
            ...
            <div class="col-md-6" data-animate="fadeInDown">
                <ul class="menu">
					...
					<li><a href="${localeEn}" class="btn btn-link btn-sm" ><img src="<spring:url value='/images/uk.png' />"/></a>
					</li>
    ...
    <div class="navbar navbar-default yamm" role="navigation" id="navbar">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand home" href='<spring:url value="/welcome"/>' data-animate-hover="bounce">
                    <img src="<spring:url value='/images/logo.png' />" class="hidden-xs">
                    <img src="<spring:url value='/images/logo-small.png' />" class="visible-xs"><span class="sr-only">Rock'n'Shop</span>
                </a>
                <div class="navbar-buttons">
                    ...
                    <a class="btn btn-default navbar-toggle" href='<spring:url value="\rocknshop/basket/yourBasket"/>'>
            ...
            <li><a href='<spring:url value="\rocknshop/catalog/${category.categoryEquivalent.idCategory}"/>'> ${category.nameCategory} </a></li>
            </c:forEach>
            ...
            <div class="navbar-buttons">
                ...
                <div class="navbar-collapse collapse right" id="basket-overview">
                    <a href='<spring:url value="\rocknshop/basket/yourBasket"/>' class="btn btn-primary navbar-btn"><i class="fa fa-shopping-cart"></i><span class="hidden-sm"><spring:message code="yourBasket"/></span></a>
                </div>
                <!--/.nav-collapse -->
            ...
            <div class="collapse clearfix" id="search">
                ...
                <form class="navbar-form" role="search" name="search" id="search" method="POST" action="/rocknshop/catalog/search">
                    <div class="products-sort-by">
                    
                        <input type="text" class="form-control" name="keyword" id="keyword" placeholder='<spring:message code="search" />'></input>
                        <select class="form-control" id="criteria" name="criteria">
					        <option value="nameModel"><spring:message code="model"/></option>
					        <option value="brand.nameBrand"><spring:message code="brand"/></option>
					        <option value="nbStrings"><spring:message code="numStrings"/></option>
    					</select>
 ...
 _________________________________________________________ -->
        <div id="footer" data-animate="fadeInUp">
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                        <h4><spring:message code="pages"/></h4>

                        <ul>
                            <li><a href='<spring:url value="/aboutus"/>'><spring:message code="about"/></a>
                            </li>
                            <li><a href='<spring:url value="/loginRegister"/>'><spring:message code="login"/></a>
                            </li>
                            <li><a href='<spring:url value="/loginRegister"/>'><spring:message code="register"/></a>
                    ...
                    <!-- /.col-md-3 -->
                        ...
                        <h4><spring:message code="inTouch"/></h4>
