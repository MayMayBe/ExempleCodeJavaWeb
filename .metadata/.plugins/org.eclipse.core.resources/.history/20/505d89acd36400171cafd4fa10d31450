...
<body>
 ...
 _________________________________________________________ -->
                    ...
                    <div class="row" id="productMain">
                        ...
                        <div class="col-md-8">
                            <div class="box">
                                ...
                                <p class="goToDescription"><a href="#details" class="scroll-to"><spring:message code="scrollTo" /></a>
                                </p>
                                <p class ="price">
                                <c:choose> 
								    ...
								    <c:when test="${not empty promotedPrice}">
								    	...
								    	<fmt:formatNumber value="${promotedPrice}" minFractionDigits="2" maxFractionDigits="2" /> € <br>
								    	<br>
                    ...
                    <div class="box" id="details">
                        <p>
                            <h4><spring:message code="productDetails" /></h4>
                            <p></p>
                            <p><spring:message code="brand" /> : ${brand.nameBrand}</p>
                            <p><spring:message code="country" /> : ${brand.country.countryName}</p>
                            <p><spring:message code="fretless" /> : ${fretlessModel}</p>
                            <p><spring:message code="numStrings" /> : ${numStrings}</p>
                             <p><spring:message code="description" /> : ${description.description}</p>
                            <hr>
                            <div class="social">
                                <h4><spring:message code="showIt" /></h4>
                                <p>
